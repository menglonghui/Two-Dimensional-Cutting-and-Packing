function [struct2] = find_best_dxy2(heiban,I2_t0,I2_t,I2_t_max,Parent0,template,key,maxIt_va,...
...
struct2.dy2 = dy2;
struct2.dy3 = dy3;
struct2.sita10 = sita10;
struct2.sita1 = sita10;
struct2.beta = beta;
struct2.I1 = imresize(I1_hr,1/imrf);
struct2.I2 = imresize(I2_hr,1/imrf);
struct2.I3 = imresize(I3_hr,1/imrf);
struct2.SP = SP;
struct2.XP = XP;
struct2.ZP = ZP;
struct2.YP = YP;
...
struct2.ii = ii;
struct2.coordinate = [];
% dxy_struct=[struct2,struct2,struct3,struct4];
disp('find_best_dxy2完成');
end
