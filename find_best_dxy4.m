function [struct4] = find_best_dxy4(heiban,I2_t0,I2_t,I2_t_max,Parent0,template,key,maxIt_va,nPop,...
    nVar,n,lx1,ly1,nC,maxIt,W0,L0,kb,partgap,N_times,imrf_special,sita_xz)
...
%接下来将图排成水平，即将dy3变为0
if exist('i_best','var')
    gama = atan((dy333_ro - i_best * dy222_ro) / (dx333_ro - i_best * dx222_ro)) * 180 / pi;%gama为为了将图像进行水平排布为旋转的角度,有问题，因为有可能dx3和dy3不是相邻的两列的差值
else
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%下面将零件摆平，并寻找合适的间距值
[dx11,dy11,dx22,dy22,dx33,dy33,sita1,ZP,YP,~,~,~,~,~] = baiping(I1_hr,I2_hr,I3_hr,I2_hr_3,I2_hr_3_10,I2_t_max,I1_hr_10,I2_hr_10,I3_hr_10,I2_t_max_10,...
    sita1,beta,gama,ZP,YP,SP,XP,dx1,dy1,dx2,dy2,dx3,dy3,1,imrf_special);
%         imshow(I3_hr);
...
struct4.dy2 = dy2;
struct4.dy3 = dy3;
struct4.sita10 = sita10;
struct4.sita1 = sita10;
struct4.beta = beta;
struct4.I1 = imresize(I1_hr,1/imrf);
struct4.I2 = imresize(I2_hr,1/imrf);
struct4.I3 = imresize(I3_hr,1/imrf);
struct4.SP = SP;
struct4.XP = XP;
struct4.ZP = ZP;
struct4.YP = YP;
...
struct4.ii = ii;
struct4.coordinate = [];
% dxy_struct=[struct4,struct4,struct4,struct4];
disp('find_best_dxy4完成');
end
