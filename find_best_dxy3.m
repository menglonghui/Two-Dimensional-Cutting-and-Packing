function [struct3] = find_best_dxy3(heiban,I2_t0,I2_t,I2_t_max,Parent0,template,key,maxIt_va,...
    nPop,nVar,n,lx1,ly1,nC,maxIt,W0,L0,kb,partgap,N_times,imrf_special,sita_xz)
...
struct3.dy2 = dy2;
struct3.dy3 = dy3;
struct3.sita10 = sita10;
struct3.sita1 = sita10;
struct3.beta = beta;
struct3.I1 = imresize(I1_hr,1/imrf);
struct3.I2 = imresize(I2_hr,1/imrf);
struct3.I3 = imresize(I3_hr,1/imrf);
struct3.SP = SP;
struct3.XP = XP;
struct3.ZP = ZP;
struct3.YP = YP;
...
struct3.ii = ii;
struct3.coordinate = [];
% dxy_struct=[struct3,struct3,struct3,struct4];
disp('find_best_dxy3完成');
end
